 ...
 * listing collections.
 */
export declare type LackOfPermissionsCallback = (db: string, error: ListDatabasesError | ListCollectionsError) => void;
/**
 ...
 * a MongoDB database.
 */
export declare class MongoScanner {
    private cache;
    private database;
    private persistentConnected;
    private persistentActives;
    private _uri;
    ...
    private set connectionOptions(value);
    private get options();
    ...
    private mergeOptionsWithDefault;
