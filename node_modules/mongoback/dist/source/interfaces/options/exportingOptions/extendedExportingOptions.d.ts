 ...
 */
export declare type ExportingFileName = string | ((db: string, collection: string, type: 'json' | 'csv') => string);
/**
 ...
 */
export declare type ExportingFilePath = string | ((db: string, collection: string, type: 'json' | 'csv', outPath: string) => string);
/**
