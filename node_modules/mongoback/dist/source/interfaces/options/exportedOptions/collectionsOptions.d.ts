 ...
 */
export declare type LambdaCollection = ((db: string, collection: string) => (boolean | ExportingOptions));
/**
 ...
 */
export declare type DetailedCollection = {
    /**
 ...
 */
export declare type GeneralCollection = string | RegExp | DetailedCollection | LambdaCollection;
/**
 ...
 * will be exported.
 */
export declare type GeneralCollections = GeneralCollection | GeneralCollection[];
/**
 ...
 */
export declare type DetailedGeneralCollections = {
    /**
 ...
 */
export declare type Collection = SpecificCollections | GeneralCollection;
/**
 * The type of the "collections" option. It defines the collections that will be exported.
 */
export declare type Collections = Collection | Collection[];
/**
 ...
 */
export declare function instanceofLambdaCollection(obj: GeneralCollection): obj is LambdaCollection;
/**
 ...
 */
export declare function instanceOfGeneralCollection(obj: Collection): obj is GeneralCollection;
