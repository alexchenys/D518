 ...
 */
export declare type LambdaDatabase = ((db: string) => (boolean | ExportingOptions));
/**
 ...
 */
export declare type DetailedDatabase = {
    /**
 ...
 */
export declare type Database = string | RegExp | DetailedDatabase | LambdaDatabase;
/**
 ...
 * will be exported.
 */
export declare type Databases = Database | Database[];
/**
 ...
 */
export declare function instanceOfLambdaDatabase(obj: Database): obj is LambdaDatabase;
