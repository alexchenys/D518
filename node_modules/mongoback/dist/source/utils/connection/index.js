...
function getMongoConnectionUri(options) {
    var uri = options.uri;
    if (!uri) {
        var protocol = options.srv ? 'mongodb+srv' : 'mongodb';
        var host = (Array.isArray(options.host)
            ? "" + options.host.map(function (_a) {
        ...
        var auth = options.username
            ? (options.password
                ...
                : options.username + "@")
            : '';
        var opt = getOptionsString(options);
        uri = protocol + "://" + auth + host + opt;
    }
    return uri;
}
function getMongoConnectionFromOptions(options) {
    return __awaiter(this, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getMongoConnectionOptions(options)];
...
exports.getMongoConnectionFromOptions = getMongoConnectionFromOptions;
